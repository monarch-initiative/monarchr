#' Fetch neighborhood of nodes in a graph based on outgoing edges
#' 
#' @param g A graph
...
#' phenos <- g %>%
#'   fetch_outgoing(predicates = "biolink:has_phenotype", result_categories = "biolink:PhenotypicFeature")
#' 
#' ancestors <- g %>%
#'  fetch_outgoing(predicates = "biolink:subclass_of", transitive = TRUE)
#' 
#' @import tidygraph
#' @import dplyr
...
#'
#' 
fetch_outgoing <- function(g, predicates = NULL, result_categories = NULL, transitive = FALSE, drop_unused_query_nodes = FALSE) {
