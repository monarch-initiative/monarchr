...
As described by [MONDO](https://mondo.readthedocs.io/en/stable/editors-guide/rare-disease-subset/), the `subsets` column lists which rare-disease subsets each disease belongs to.
