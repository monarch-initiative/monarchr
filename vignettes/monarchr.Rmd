...
<center>![Small KG visualization showing node and edge properties, with id, category, subject, and object bolded, and other properties such as name present.](assets/cftr_cf_edge.png){width=90%}</center>
...
While most features of `monarchr` are applicable to any KGX-formatted KG, some are specific to functionality provided by the
Monarch Initiative.
